...
public class InstrumentoController {
    ...
    public InstrumentoController(InstrumentoUseCase instrumentoUseCase, InstrumentoDTOConverter converter) {
    ...
    public ResponseEntity<InstrumentoResponse> buscarPorId(@PathVariable Long id) {
        return ResponseEntity.ok(converter.toResponse(instrumentoUseCase.buscarPorId(id)));
    }
